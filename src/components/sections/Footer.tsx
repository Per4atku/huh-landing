      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          >
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <span className="text-2xl font-bold">Huh</span>
            </Link>
            <p className="text-gray-400 text-sm max-w-xs">
              Reflect, Strategize, and Monitor all in one place. Effectively organize your tasks and enhance productivity.
            </p>
            {/* Social links */}
        ...
        >
          <p className="text-gray-500 text-sm">
            {new Date().getFullYear()} Huh. All rights reserved.
          </p>
